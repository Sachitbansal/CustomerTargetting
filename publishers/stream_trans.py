...
def stream_trans(batch_size=15, delay=1.5):
    """
    Synchronous wrapper for streaming a single batch of transaction data.
    ...
    try:
        ...
        print(f"  [TRANS] Would publish {rows_to_publish} rows")
