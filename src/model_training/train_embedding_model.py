...
from ..data_preprocessing.split_data import split_train_test
...
def train_model():
    ...
    # Step 2: Load loan user data for similarity target
    print("\n[Step 2] Loading loan user data for similarity target...")
