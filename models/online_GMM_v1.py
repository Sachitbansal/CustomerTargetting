...
class onlineGMMv1:
    ...
    def __init__(self, num_dim, cat_dims, kMax=150, 
                 significance_level=0.05, learning_rate=0.08, neg_learning_rate=0.05,
                 max_idle_iterations=500, fn_buffer_size=50, fn_buffer_kMax=7,
    ...
    def predict_score(self, x_num, x_cat):
        ...
        is_in = (best_m < self.chi2_threshold)
