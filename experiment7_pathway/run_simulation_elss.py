...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run ELSS simulation with Pathway')
    ...
    pw.io.csv.write(processed_table, "pathway_output_elss.csv")
