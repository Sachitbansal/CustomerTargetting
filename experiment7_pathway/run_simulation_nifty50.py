...
from pipeline_config import NIFTY50_CONFIG # <-- Import the specific config

# --- Configuration from Imported Dictionary ---
CONFIG = NIFTY50_CONFIG
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run Nifty50 simulation with Pathway')
    ...
    pw.io.csv.write(processed_table, "pathway_output.csv")
